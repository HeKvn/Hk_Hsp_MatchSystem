...
namespace DAL
{
    public class Class1
    {
        ...
        public bool select(Model.Users user)
        {
            ...
            con.Open();
            string sqlstr = "select ID from user where name=@name and pwd=@pwd";
        ...
        public bool select1(Model.Users user)
        {
            ...
            MySqlConnection con = new MySqlConnection(str1);
            con.Open();
            string sqlstr = "select ID from user where name=@name and tel=@tel";
            MySqlCommand cmd = new MySqlCommand(sqlstr, con);
            cmd.Parameters.AddWithValue("@name", user.name);
        ...
        public bool select2(Model.Users1 user1)
        {
            ...
            MySqlConnection con = new MySqlConnection(str1);
            con.Open();
            string sqlstr = "select ID from user1 where name=@name";
            MySqlCommand cmd = new MySqlCommand(sqlstr, con);
